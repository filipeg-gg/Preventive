...
export default function Consulta({ navigation }) { // <--- Mude o nome da função em cada arquivo
  const route = useRoute();

  // === CONFIGURAÇÃO ESPECÍFICA DE CADA TELA ===
  // Na TelaExame.js mude para "Exame"
  // Na TelaResultado.js mude para "Resultado"
  const TIPO_FIXO = "Consulta"; 
  const COR_FUNDO = "#e0f7fa"; // Consulta(#e0f7fa), Exame(#ffe4f0), Resultado(#f9f9fb)
  // ============================================
